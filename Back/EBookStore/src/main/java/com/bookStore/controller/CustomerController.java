...
public class CustomerController {
	...
	public ResponseEntity<Status> register(@RequestBody @Valid Customer customer) {
		try {
	...
	@GetMapping("/receiptCustomer/{id}")
	public List<Receipt> fetchByRecieptByCustomerId(@PathVariable int id) {
		return customerService.fetchRecieptByCustomerId(id);
	}
